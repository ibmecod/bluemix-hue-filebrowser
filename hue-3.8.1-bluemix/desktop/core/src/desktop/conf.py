...
## Bluemix Apache Hadoop change - need Hadoop password to access WebHdfs 
DEFAULT_HDFS_SUPERUSER_PASSWORD = Config(
  key="default_hdfs_superuser_password",
  help=_("This should be the hdfs super user password"),
  type=str,
  default=None)
